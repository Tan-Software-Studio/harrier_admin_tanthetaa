    ...
    <DashboardLayout>
      ...
      <MDBox component="form" role="form" className="employer-details-container">
        <MDBox className="employer-fields">
          ...
          <MDBox m={2} className="detail-content">
            <MDTypography className="title">
              Employer Types <span className="text-red"> * </span>
            </MDTypography>
            <Autocomplete
          ...
          {/* <MDBox m={2} className="detail-content">
            <MDTypography className="title">HQ Address (if other than UK address)</MDTypography>
            <MDInput
              type="text"
              name="hq_address"
              onChange={onChange}
          ...
          <MDBox m={2} className="detail-content">
            <MDTypography className="title">Office Address</MDTypography>
            <MDInput
              type="text"
              name="hq_address"
              onChange={onChange}
          ...
          <MDBox m={2} className="detail-content">
            ...
            <MDInput type="file" name="logo" onChange={onChangeLogo} className="text-field" />
          </MDBox>
