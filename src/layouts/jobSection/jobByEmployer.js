              ...
              <div className="row m-10">
                {jobDetails.map((collapsed, i) => (
                  <div className="" key={i}>
                    <div
                      className={`${
                        collapse === i ? "full" : "small"
                      } my-job-box position-relative`}
                    >
                      <div className="d-flex justify-content-between">
                        ...
                        <div className="d-flex">
                          {collapsed?.job_attach_file_path == null ? null : (
                            <a href={`${collapsed?.job_attach_file_path}`} target="_blank">
                              <MDButton
                                variant="contained"
                                color="success"
